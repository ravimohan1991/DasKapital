...
\item Mathematics again comes to our rescue in reversing the relation to
  ...
  \item A single commodity by itself can't acquire the two forms of value expression as evident from the meaning of the equation \ref{eq:exchangemean}.
...
The relation \ref{eq:exchangemean} with $\Phi$ as
