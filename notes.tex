...
\begin{equation}
 ...
 \begin{itemize}
  ...
  \item The series \ref{eq:totformofexval} be terminating in a practise. 
  \end{itemize}
  Once it is done, whatever we are left with is essentially the \emph{total form} of Value.

  Now, we remark
  \begin{itemize}
  \item Value of every commodity (present in the series \ref{eq:totformofexval}) is expressed in terms of single commodity and can be deciphered by humans.  This is precisely because of the element of generality leading to this categorical unification.
    \item 
  \end{itemize}
