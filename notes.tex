...
\item Next, we demand the following explicit dependence of $a$ like so
 ...
 \begin{theorem}
 Change in $v^{r}$ (given the mathematical form \ref{eq:relvalform}) is \underline{sufficient} condition for reflecting change in the value of the commodity.\footnote{The symbol for relative value, of generic commodity, is written by ommiting the sub-text.}
 \end{theorem}
