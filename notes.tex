...
We have to keep in mind how much role the commodity owners play, in the background, in determining the context for elementary form of Value.

\subsection{The General Form of Value}
Consider another representation of the equation \ref{eq:totformofexval}
\begin{equation}
  \label{eq:genformval}
  (\text{np})_{\text{coat}}^{\omega}=
   \begin{cases} 
    2\cdot (10\text{yd})_{\text{linen}}^{\omega}\\
     (10\text{lbs})_{\text{tea}}^{\omega} \\
      \ldots
   \end{cases}.
 \end{equation}
 \subsubsection{The altered character of the form of Value}
